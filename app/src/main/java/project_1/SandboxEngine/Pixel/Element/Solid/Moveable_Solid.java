...
public class Moveable_Solid extends Solid {
    ...
    public void update(){
        ...
        //If the static counter reaches multiple of the fall rate, then update the next state
    ...
    protected void fall_down_solid(){
        ...
        if(CellularAutomata.get().pos_allowed(check)){
            //If this position is empty, then move this pixel to that place
        ...
        //Keep this pixel where it is if it can not move
        CellularAutomata.get().add_pixel(this, this.position, true);
    }
